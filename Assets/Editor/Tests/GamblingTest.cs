...
public class GamblingTest {
    ...
    /// For example, the market has £15, a player wants to play with a wager of £10. The market can't afford the £20 reward, but it can after recieving payment from the player
    /// </summary>
    [Test]
